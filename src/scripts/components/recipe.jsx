...
class Recipe extends React.Component {
      ...
      {this.state.isActive ? (
        <form noValidate="noValidate" onSubmit={(e) => { e.preventDefault(); this.props.modifyRecipe(this.props.index, this.state.name, this.state.ingredients); }}>
          ...
          <div className="row col-sm-12 col-md-2">
            <input className="primary" type="button" value="Add Ingredient" onClick={this.addIngredient.bind(this)} />
          </div>
          <div className="row col-sm-12 col-md-2">
  ...
  addIngredient(){
    ...
    let newState = Object.assign({}, this.state, {ingredients: newIngredientList});
    this.setState(newState);
  }
}
